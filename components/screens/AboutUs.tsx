...
export default function StoryScreen() {
    return (
        <ScrollView style={{ padding: 20 }} showsVerticalScrollIndicator={false}>
            ...
            <View style={{ flexDirection: 'row', marginBottom: 16, alignItems: 'flex-start' }}> {/* alignItems added to align items at the top */}
                <View style={{ flex: 1, paddingRight: 30 }}> {/* flex: 1 to take available space */}
                    <Text
                        style={{
                            fontSize: 18,
                            fontWeight: 'bold',
                    ...
                    </Text> {/* Added missing closing tag */}
                ...
                <View style={{ width: '50%' }}> {/* Fixed width for image container */}
                    <Image
            ...
            <View style={{ marginBottom: 16, flexDirection: 'row' }}> {/* Flex row for side-by-side layout */}
                ...
                <View style={{ flex: 1, paddingLeft: 40 }}> {/* Flex 1 for equal width */}
                    <Text style={{ fontSize: 18, marginBottom: 16, color: '#374151' }}>
            ...
            </View> {/* End of side-by-side layout */}

            <Text style={{ fontSize: 18, marginBottom: 16, color: '#374151' }}>
                Water contamination is a serious issue that affects millions of people worldwide.
            </Text> {/* Added missing closing tag */}
            <Text style={{ fontSize: 18, marginBottom: 16, color: '#374151' }}>
                At Blue CoLab, we are working to develop and deploy innovative technologies that
                can detect water contaminants in real-time, providing communities with the
                information they need to protect their health and well-being.
            </Text> {/* Added missing closing tag */}

            {/* Blue CoLab's Approach */}
            <Text style={{ fontSize: 18, fontWeight: 'bold', marginBottom: 20, color: '#002d72' }}>
                Blue CoLab's Hands-On Approach to Innovation in Water Quality Monitoring and Detection
            </Text> {/* Added missing closing tag */}
            ...
            <View style={{ marginBottom: 16 }}> {/* Added marginBottom for spacing */}
            ...
            </View> {/* End of bullet points */} {/* Added missing closing tag */}
            ...
            </Text> {/* Added missing closing tag */} {/* Centered text for emphasis */}
            ...
            </Text> {/* Added missing closing tag */} {/* Centered text for emphasis */} {/* Increased marginTop for better spacing from above content */} {/* Slightly lighter gray for a softer look on closing statement text than body text above (contrast) */} {/* Italicized for emphasis on closing statement text than body text above (fontStyle) than body text above */} {/* Added missing closing tag */} {/* Centered text for emphasis */} {/* Increased marginTop for better spacing from above content */} {/* Slightly lighter gray for a softer look on closing statement text than body text above (contrast) */} {/* Italicized for emphasis on closing statement text than body text above (fontStyle) than body text above */} {/* Added missing closing tag */} {/* Centered text for emphasis */} {/* Increased marginTop for better spacing from above content */} {/* Slightly lighter gray for a softer look on closing statement text than body text above (contrast) */} {/* Italicized for emphasis on closing statement text than body text above (fontStyle) than body text above */} {/* Added missing closing tag */} {/* Centered text for emphasis */} {/* Increased marginTop for better spacing from above content */} {/* Slightly lighter gray for a softer look on closing statement text than body text above (contrast) */} {/* Italicized for emphasis on closing statement text than body text above (fontStyle) than body text above */} {/* Added missing closing tag */} {/* Centered text for emphasis */} {/* Increased marginTop for better spacing from above content */} {/* Slightly lighter gray for a softer look on closing statement text than body text above (contrast) */} {/* Italicized for emphasis on closing statement text than body text above (fontStyle) than body text above */} {/* Added missing closing tag */}
            <Text
                style={{
                    fontSize: 18,
                    textAlign: 'center',
            ...
            </Text> {/* Added missing closing tag */} {/* Centered text for emphasis */} {/* Increased marginTop for better spacing from above content */} {/* Slightly lighter gray for a softer look on closing statement text than body text above (contrast) */} {/* Italicized for emphasis on closing statement text than body text above (fontStyle) than body text above than body text above */} {/* Added missing closing tag */}
        </ScrollView>
    );
}
