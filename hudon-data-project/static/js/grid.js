...
const app = {
    ...
    updateDisplay() {
        ...
        lastUpdate.textContent = new Date(
            this.data[this.data.length - 1].Datetime
        ).toLocaleString();
    ...
    updateValueCards(data) {
        const measurements = [
            ...
            {
                key: 'Dissolved Oxygen (mg/L)',
                label: 'Dissolved O₂',
                unit: 'mg/L',
                color: '#4caf50',
            },
            {
                key: 'Dissolved Oxygen Saturation (%)',
                label: 'DO Saturation',
                unit: '%',
                color: '#8bc34a',
            },
        ...
        container.innerHTML = measurements
            .map((m) => {
    ...
    createCharts() {
        ...
        chartsGrid.innerHTML = chartsConfig
            .map(
                (config) => `
